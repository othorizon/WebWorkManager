<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MinRegister.aspx.cs" Inherits="MinRegister" %>
...
<body>
    ...
    <form runat="server">
        ...
        <div id="dvmain" class="auto-style1" style="filter: progid:DXImageTransform.Microsoft.gradient(startColorstr='#3f000000',endColorstr='#3f000000'); background-color: rgba(255, 255, 255,0.3);">
            <div style="font-family: 微软雅黑; color: #0099FF;">
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 用户注册&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                <input type="button" style="border: none; background-color: transparent; cursor: pointer" value="X" onclick="reclose()" class="auto-style2" /></div>
        ...
        function returnstudent() {
            $('#<%=td_username.ClientID%>').css({ "opacity": "1", "height": "26px" });
            $('#<%= tb_stepstudent.ClientID%> > div').css({ "opacity": "1", "height": "23px" });

            window.parent.registermsg($('#<%=tb_username.ClientID%>').val());
            reclose();
        }
        function returnteacher() {
            $('#<%=td_username.ClientID%>').css({ "opacity": "1", "height": "26px" });
            $('#<%= tb_stepteacher.ClientID%> > div').css({ "opacity": "1", "height": "23px" });
        ...
        function reclose() {
            ...
            $('div').animate({ opacity: 0, height: '1px' }, 800);
            window.parent.hideregister();
        }
        </script>
    </form>
</body>
